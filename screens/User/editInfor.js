...
import { Text, View, TextInput, TouchableOpacity, Modal, Pressable, StyleSheet, Dimensions } from 'react-native';
            ...
            return (
                <View style={styles.container}>
                    ...
                    <TextInput
                        ...
                        multiline={true}
                        keyboardType={props.title == 'số điện thoại' ? 'numeric': 'default'}
                    />
                    <TouchableOpacity
                        style={{
                            width: 200,
