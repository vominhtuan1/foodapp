...
import { View, Text, Image, TouchableOpacity, Dimensions, StyleSheet, TextInput, ScrollView, SafeAreaView } from 'react-native';
...
const methods = [
    { text: 'Thanh toán khi nhận hàng', key: 1, image: require('../../../assets/loan.png') },
        ...
        <SafeAreaView style={{ backgroundColor: 'white', height: '100%' }}>
            ...
            <ScrollView >
                <View style={{ justifyContent: 'center', alignItems: 'center' }} >
                    ...
                    <View style={styles.deliveryContainer}>
                        ...
                        <Text style={[styles.text, { color: '#a4a4a4' }]}>Tiêu chuẩn(20,000 đồng)</Text>
                    </View>
            ...
            <View>
                ...
                <TouchableOpacity 
                    ...
                    onPress={() => chechOut()}
                >
                    <Text style={{ fontFamily: 'Comfortaa_Regular', fontSize: 20, color: 'white', alignSelf: 'center' }}>Xác nhận</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
